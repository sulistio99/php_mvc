<div class="container mt-3">
  ...
  <div class="row mb-3">
    <div class="col-lg-6">
      <button type="button" class="btn btn-primary tomnolTambahData" data-toggle="modal" data-target="#formModal">
    ...
    <div class="col-lg-6">
      <form action="<?= BASEURL; ?>/mahasiswa/cari" method="POST">
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Masukkan Pencarian..." aria-describedby="button-addon2" name="keyword" id="keyword" autocomplete="off">
